    ...
    <div className="d-flex flex-column align-items-center justify-content-center min-vh-100 py-4 bg-light">
      ...
      <div className="card shadow-sm p-4 w-100" style={{ maxWidth: "440px", borderRadius: "1.25rem" }}>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="row g-2">
              <div className="col-6">
                <button
                  ...
                  className={`w-100 p-3 btn text-center border d-flex flex-column align-items-center justify-content-center ${
                    accountType === "comprador" ? "border-primary text-primary fw-semibold" : "border-secondary-subtle text-secondary"
                  }`}
                  style={{ 
                    borderRadius: "0.5rem", 
              ...
              <div className="col-6">
                <button
                  type="button"
                  className={`w-100 p-3 btn text-center border d-flex flex-column align-items-center justify-content-center ${
                    accountType === "vendedor" ? "border-primary text-primary fw-semibold" : "border-secondary-subtle text-secondary"
                  }`}
                  style={{ 
                    borderRadius: "0.5rem", 
          ...
          <button type="submit" className="btn btn-primary w-100 fw-semibold" style={{ height: "3.2rem", borderRadius: "0.5rem" }}>
            Criar Conta
          </button>

          {/* 3. Botão modificado para usar o navigate */}
